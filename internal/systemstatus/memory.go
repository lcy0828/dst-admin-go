...
func (p *MemoryProvider) Status() Status {
	return Status{
		...
		CPU:        CPUStatus{Available: true, Model: "Test CPU", Cores: 4, Threads: 8, Usage: 37.5, CoreUsage: []float64{20, 35, 45, 50}, Load1: 0.8, Load5: 0.6, Load15: 0.4, LoadSupport: true},
